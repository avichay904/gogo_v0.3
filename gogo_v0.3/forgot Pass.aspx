<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgot Pass.aspx.cs" Inherits="gogo_v0._3.forgot_Pass" %>
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">איפוס סיסמה</p>
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" dir="rtl" for="form3Example1c">שם פרטי</label>
                    </div>
                  </div>
                 ...
                 <asp:Button ID="Btn_ForgotPass" Text="שלח" runat="server" CssClass="btn btn-primary btn-lg" OnClick="Btn_ForgotPass_Click" />
