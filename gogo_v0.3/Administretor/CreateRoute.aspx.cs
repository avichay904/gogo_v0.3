...
namespace gogo_v0._3.Administretor
{
    public partial class CreateRoute : System.Web.UI.Page
    {
        ...
        protected  void creatRout_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    string url = $"https://maps.googleapis.com/maps/api/directions/json?origin={OriginUrl},+ישראל&destination={DestUrl},+ישראל&waypoints=optimize:true|{WayPoints}&key=A-Kp2UkU&waypoiny";
